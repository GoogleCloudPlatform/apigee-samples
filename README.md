...
|6| [llm-security](llm-security) | Sample to demonstrate the security capabilities of Apigee with Model Armor (using Service Callout) to secure the user prompts |  [![notebook](https://cloud.google.com/ml-engine/images/colab-logo-32px.png)](./llm-security/llm_security_v1.ipynb) |
|7| [llm-security-v2](llm-security-v2) | Sample to demonstrate the security capabilities of Apigee with out of the box Model Armor policies to secure the user prompts |  [![notebook](https://cloud.google.com/ml-engine/images/colab-logo-32px.png)](./llm-security-v2/llm_security_v2.ipynb) |
