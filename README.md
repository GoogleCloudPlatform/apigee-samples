...
|6| [llm-vertexai-agent](llm-vertexai-agent) | Sample to deploy an agent using Vertex Agent Builder and point to an Apigee proxy |  [![notebook](https://cloud.google.com/ml-engine/images/colab-logo-32px.png)](./llm-vertexai-agent/llm_vertexai_agent.ipynb) |
