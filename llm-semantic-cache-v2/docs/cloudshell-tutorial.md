...
* Set the <walkthrough-editor-select-regex filePath="llm-semantic-cache-v2/env.sh" regex="MODEL_ID_TO_SET">MODEL_ID</walkthrough-editor-select-regex> to send generative prompts to. For example, `gemini-2.5-pro`.
