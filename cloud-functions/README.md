...
Now open the file [target-1.xml](./bundle/apiproxy/targets/target-1.xml) in your favorite text editor so that you can edit it.
...
organization, first source your `env.sh` script, and then run the cleanup script:
