...
echo " "
echo "curl -i --location \"https://$APIGEE_HOST/v2/samples/llm-security/v1/projects/$PROJECT_ID/locations/${MODEL_ARMOR_REGION}/publishers/google/models/${MODEL_NAME}:generateContent\" \\"
