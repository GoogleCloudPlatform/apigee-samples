...
echo "Creating and Deploying Apigee sample-drupal-developer-portal proxy..."
REV=$(apigeecli apis create bundle -f apiproxy -n sample-drupal-developer-portal --org "$PROJECT" --token "$TOKEN" --disable-check | jq ."revision" -r)
